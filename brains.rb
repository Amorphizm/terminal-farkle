...
#         bank_temp = 0
#         puts "Current score - #{score} | bank total - #{bank_hold}"
...
#             farkle_count += 1
#             if farkle_count == 3 
#                 puts "Wow! You have 3 farkles - your score and farkle count have been reset to 0."
#                 score = 0
#                 farkle_count = 0
#             else 
#                 puts "You have a total of #{farkle_count} farkles."
#             end 
#             pass_turn = true
#         else
...
#                 end 
#             else #create a new dice set
#                 puts "Passing the turn."
#                 score += bank_hold
#                 pass_turn = true              
#             end 
#         end 
